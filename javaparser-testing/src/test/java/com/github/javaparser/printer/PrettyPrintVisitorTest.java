...
public class PrettyPrintVisitorTest {
    ...
    public void printLambdaIntersectionTypeAssignment() {
        ...
        assertEquals("Runnable r = (Runnable & Serializable) (() -> {" + EOL + "});", print(methodDeclaration.getOptionalBody().get().getStatements().get(0)));
    }
    ...
    public void printLambdaIntersectionTypeReturn() {
        ...
        assertEquals("return (Comparator<Map.Entry<K, V>> & Serializable) (c1, c2) -> c1.getKey().compareTo(c2.getKey());", print(methodDeclaration.getOptionalBody().get().getStatements().get(0)));
    }
